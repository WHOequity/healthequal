...
#'  the same level of the indicator as a reference group.
#'
#'  PAR is calculated as the difference between the estimate for the
#'  reference subgroup and the setting average. For more information
...
#'  The larger the absolute value of PAR, the higher the level of inequality.
#'  PAR is zero if no further improvement can be achieved (i.e., if all
#'  subgroups have reached the same level of the indicator as the reference
#'  subgroup or surpassed that level).
#'
